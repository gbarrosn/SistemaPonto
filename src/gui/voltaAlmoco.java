 ...
 * @author gbarrosn
 */
public class voltaAlmoco extends javax.swing.JFrame {

    /**
     * Creates new form voltaAlmoco
     */
    public voltaAlmoco() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registrar volta do almoço");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(voltaAlmoco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new voltaAlmoco().setVisible(true);
            }
        });
    }
